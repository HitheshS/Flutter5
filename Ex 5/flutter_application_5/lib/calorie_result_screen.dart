...
class CalorieResultScreen extends StatelessWidget {
  ...
  Widget build(BuildContext context) {
    ...
    final remCal = user.dailycalorie - totalcalorie;
    return Scaffold(
          ...
          children: [
            ...
            Card(
              ...
              child: ListTile(
                ...
                subtitle: Text('Remaining Calorie: $remCal'),
                trailing: (remCal >= 0)? Text('You are within your daily goal', style: TextStyle(color: Colors.green, fontSize: 10),): Text('You exceeded your daily goal', style: TextStyle(color: Colors.red, fontSize: 10),
                )
              ),
            ),
